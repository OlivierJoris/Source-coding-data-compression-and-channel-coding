...
The original text has a size of 2061550 bits. Thus, we get a compression rate of $0.941 = \frac{2061550}{2190809}$.

%%%%%

\subsection{Question 13}
\paragraph{}In order to increase the compression rate, we could use a modified Huffman algorithm for which, instead of considering individual letters, we would consider
